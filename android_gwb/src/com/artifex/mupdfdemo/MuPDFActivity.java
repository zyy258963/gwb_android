...
public class MuPDFActivity extends Activity {
	...
	public void createUI(Bundle savedInstanceState) {
		...
		mFilenameView.setText(ConstantParams.CURRENT_BOOK_NAME);
				...
				AlertDialog.Builder builder = new Builder(MuPDFActivity.this)
						...
						.setPositiveButton("继续", new OnClickListener() {
							...
							public void onClick(DialogInterface dialog, int arg1) {
								...
								Set<String> set = sp
										.getStringSet(
												ConstantParams.FIELD_FAVOURITE_BOOK_SET,
												null);
								if (set == null) {
									...
									new AddFavoriteAsynTask()
											.execute(ConstantParams.CURRENT_BOOK_ID);
									// }
								} else {
		...
		// AnimatorInflater.loadAnimator(context, R.animator.info);
	...
	void makeButtonsView() {
		...
		mFavouriteButton = (ImageButton) mButtonsView
				.findViewById(R.id.favouriteButton);
		// mReflowButton =
		// (ImageButton)mButtonsView.findViewById(R.id.reflowButton);
		// mSelectButton =
		// (ImageButton)mButtonsView.findViewById(R.id.selectButton);
		// mCancelSelectButton =
		// (ImageButton)mButtonsView.findViewById(R.id.cancelSelectButton);
		// mCopySelectButton =
		// (ImageButton)mButtonsView.findViewById(R.id.copySelectButton);
		// mStrikeOutButton =
		...
		// mSearchBack =
		// (ImageButton)mButtonsView.findViewById(R.id.searchBack);
		// mSearchFwd =
		...
		protected void onPostExecute(Boolean result) {
			...
			if (result) {
				...
				try {
					...
					Toast.makeText(MuPDFActivity.this, "添加成功",
